...
TEXT_FILES_FOLDER = 'C:\\Users\\omowu\\OneDrive\\Desktop\\Fall 2024\\Senior Project\\text_annotation_tool\\text_annotation_tool\\backed_server\\text_data'
...
async def list_files():
    print("my folder",TEXT_FILES_FOLDER)
    cwd = os.getcwd()
    print(cwd)
